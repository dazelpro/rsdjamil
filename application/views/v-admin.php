...
<body>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalNew">Tambah Admin</button>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped" id="mytable">
                                    ...
                                    <tbody>
                                        <?php 
                                            foreach ($dataAdmin->result() as $row):
                                        ?>
                                        <tr>
    ...
    <!-- New Data Modal -->
    <form action="<?php echo site_url('account/insert-admin');?>" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" name="code" value="A<?php echo sprintf("%04s", $code)?>">
    ...
    <form action="<?php echo site_url('account/update-admin');?>" method="post">
    ...
    <!-- Delete Modal -->
    <?php foreach ($dataAdmin->result() as $row): ?>
    <form action="<?php echo site_url('account/delete-admin');?>" method="post">
        <div class="modal fade" id="modalDelete<?php echo $row->id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="code" value="<?php echo $row->id;?>">
                        <p>Anda ingin menghapus Admin <b><?php echo $row->name;?></b> ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
                            <i class="bi bi-x d-block d-sm-none"></i>
