            ...
            <div id="main-content">
                ...
                <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Pendapatan Berdasarkan Pemakaian Film</h3>
                            </div>
                        </div>
                    </div>
                    <section class="section">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url().'report/income/film'?>" class="btn btn-outline-primary"  target="_blank">Cetak</a>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Pendapatan Berdasarkan Tindakan</h3>
                            </div>
                        </div>
                    </div>
                    <section class="section">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url().'report/income/handling'?>" class="btn btn-outline-primary"  target="_blank">Cetak</a>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Pendapatan Berdasarkan Asal Ruangan</h3>
                            </div>
                        </div>
                    </div>
                    <section class="section">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo base_url().'report/income/room'?>" class="btn btn-outline-primary"  target="_blank">Cetak</a>
                            </div>
                        </div>
                    </section>
                </div>
