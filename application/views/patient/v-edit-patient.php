        ...
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                ...
                <div class="page-heading">
                    ...
                    <form action="<?php echo site_url('patient/update-patient');?>" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mr" value="<?php echo $row->mr_number;?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                            <div class="form-group">
                                                <label for="basicInput">Nama Pasien</label>
                                                <input type="text" name="name" value="<?php echo $row->name;?>" class="form-control" autocomplete="off" id="basicInput" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="basicInput">Tempat Lahir</label>
                                                <input type="text" name="place" value="<?php echo $row->place_of_birth;?>" class="form-control" autocomplete="off" id="basicInput" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="basicInput">Tanggal Lahir</label>
                                                <input type="date" name="birth" value="<?php echo $row->date_of_birth;?>" class="form-control" autocomplete="off" id="basicInput" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="basicInput">Jenis Kelamin</label>
                                            </div> 
                                            <div class="form-check">
                                                <input name="gender" value="Pria" class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" <?php if($row->gender == 'Pria'):?>checked<?php endif;?> required>
                                                <label class="form-check-label" for="flexRadioDefault2">
                                                    Pria
                                                </label>
                                            </div>   
                                            <div class="form-check">
                                                <input name="gender" value="Wanita" class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" <?php if($row->gender == 'Wanita'):?>checked<?php endif;?> required>
                                                ...
                                                <div class="form-group">
                                                    <select class="form-select" id="basicSelect" name="room" required>
                                                        ...
                                                        <?php foreach ($dataRoom->result() as $i) : ?>
                                                            <option value="<?php echo $i->id;?>"<?php if($row->room == $i->id):?> selected <?php endif;?>><?php echo $i->name;?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <select class="form-select" id="basicSelect" name="doctor" required>
                                                        ...
                                                        <?php foreach ($dataDoctor->result() as $i) : ?>
                                                            <option value="<?php echo $i->id;?>"<?php if($row->doctor == $i->id):?> selected <?php endif;?>><?php echo $i->name;?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <select class="form-select" id="basicSelect" name="doctorRad" required>
                                                        ...
                                                        <?php foreach ($dataDoctorRad->result() as $i) : ?>
                                                            <option value="<?php echo $i->id;?>"<?php if($row->radiology_doctor == $i->id):?> selected <?php endif;?>><?php echo $i->name;?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary" style="float: right; margin-left: 10px;">Perbarui Data</button>
