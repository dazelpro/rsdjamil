...
<body>
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Data Akun Dokter Pengirim</h3>
                            </div>
                        </div>
                    </div>
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalNew">Tambah Dokter Pengirim</button>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped" id="mytable">
                                    ...
                                    <tbody>
                                        <?php 
                                            foreach ($dataDoctor->result() as $row):
                                        ?>
                                        <tr>
    ...
    <!-- New Data Modal -->
    <form action="<?php echo site_url('account/insert-doctor');?>" method="post">
    ...
    <!-- End -->
    <!-- Edit Modal -->
    <?php foreach ($dataDoctor->result() as $row): ?>
    <form action="<?php echo site_url('account/update-doctor');?>" method="post">
    ...
    <?php foreach ($dataDoctor->result() as $row): ?>
    <form action="<?php echo site_url('account/reset-pass-doctor');?>" method="post">
    ...
    <!-- Delete Modal -->
    <?php foreach ($dataDoctor->result() as $row): ?>
    <form action="<?php echo site_url('account/delete-doctor');?>" method="post">
