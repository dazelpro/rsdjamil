                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code" value="<?php echo $row->name;?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledInput">Tindakan</label>
                                                <input type="text" name="code" value="<?php echo $row->handling;?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledInput">Tarif</label>
                                                <input type="text" name="code" value="<?php echo number_format($row->amount);?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="disabledInput">Asal Ruangan</label>
                                                <input type="text" name="code" value="<?php echo $row->room;?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledInput">Dokter Pengantar</label>
                                                <input type="text" name="code" value="<?php echo $row->doctor_name;?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledInput">Dokter Radiologi</label>
                                                <input type="text" name="code" value="<?php echo $row->doctor_rad;?>" class="form-control" id="disabledInput" readonly required>
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group mb-3">
                                                    <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalImage">Lihat Citra Radiologi</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="divider">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <br>
                                            <div class="input-group mb-3">
                                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalImage">Simpan Hasil Bacaan</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
