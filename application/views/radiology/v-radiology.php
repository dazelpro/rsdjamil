                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <a href="<?php echo base_url().'handling/radiology/new'?>" class="btn btn-outline-primary">Tambah Citra</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url().'handling/radiology/detail/'.$row->id?>" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">Lihat</a>
